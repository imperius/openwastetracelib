...
from owt_objects import *
from owt_storage import *

mapperDescrittoreCatalogo=mapper(DescrittoreCatalogo,
                                    metadata_descrittorecatalogo)
mapperStati_scheda_sistri=mapper(Stati_scheda_sistri,
                                    metadata_stati_scheda_sistri)
mapperStati_fisici_rifiuto=mapper(Stati_fisici_rifiuto,
                                    metadata_stati_fisici_rifiuto)
mapperForme_giuridiche=mapper(Forme_giuridiche,metadata_forme_giuridiche)
mapperTipi_reg_cronologico=mapper(Tipi_reg_cronologico,
                                    metadata_tipi_reg_cronologico)
mapperOperazioni_impianti=mapper(Operazioni_impianti,
                                    metadata_operazioni_impianti)
...
mapperTipi_registrazioni_crono=mapper(Tipi_registrazioni_crono,
                                        metadata_tipi_registrazioni_crono)
...
mapperAssociazioni_categoria=mapper(Associazioni_categoria,
                                    metadata_associazioni_categoria)
mapperStati_registro_cronologico=mapper(Stati_registro_cronologico,
                                        metadata_stati_registro_cronologico)
mapperTipi_imballaggi=mapper(Tipi_imballaggi,metadata_tipi_imballaggi)
mapperSottocategorie_star=mapper(Sottocategorie_star,
                                    metadata_sottocategorie_star)
...
mapperTipi_esito_trasporto=mapper(Tipi_esito_trasporto,
                                    metadata_tipi_esito_trasporto)
...
mapperStati_registrazioni_crono=mapper(Stati_registrazioni_crono,
                                        metadata_stati_registrazioni_crono)
...
mapperCodici_cer_iii_livello=mapper(Codici_cer_iii_livello,
                                    metadata_codici_cer_iii_livello)
mapperTipi_stato_impresa=mapper(Tipi_stato_impresa,metadata_tipi_stato_impresa)
mapperCaratteristiche_pericolo=mapper(Caratteristiche_pericolo,
                                        metadata_caratteristiche_pericolo)
mapperSottotipi_veicolo=mapper(Sottotipi_veicolo,metadata_sottotipi_veicolo)
mapperAzienda=mapper(Azienda,metadata_azienda)
#mapperAzienda=mapper(Azienda,metadata_azienda,
#                        properties=dict(RelSedeLegale=relationship(SedeLegale),
#                                        RelSedi=relationship(Sede)))
